...
function cartTotalAdd() {
  document.getElementsByClassName("cart-element")[0].innerText =
    parseInt(document.getElementsByClassName("cart-element")[0].innerText) + 1;
}

function cartTotalRemove() {
  if (
    parseInt(document.getElementsByClassName("cart-element")[0].innerText) >= 0
  ) {
    document.getElementsByClassName("cart-element")[0].innerText =
      parseInt(document.getElementsByClassName("cart-element")[0].innerText) -
      1;
  }
}
